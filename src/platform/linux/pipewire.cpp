...
namespace pipewire {
  ...
  public:
    ...
    int init(platf::mem_type_e hwdevice_type, const std::string &display_name, const ::video::config_t &config) {
      ...
      const static bool negotiate_variable_rate = kwin_version.empty() || (kwin_version[0] == 5) || (kwin_version[0] == 6 && kwin_version[1] < 7) || (kwin_version[0] == 6 && kwin_version[1] == 7 && kwin_version[2] < 5);
